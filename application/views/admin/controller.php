...
<form id="savecontoller" method="Post" enctype="multipart/form-data">
	<div class="form-group">
		...
		<input type="text" class="form-control" id="controller_ip" name="controller_ip" placeholder="xxx.xxx.xx.xxx/sample.com" value="<?php echo $controller_ip; ?>">
	</div>
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" id="controller_password" name="controller_password" placeholder="Controller's Password" value="<?php echo $controller_password; ?>">
	</div>

	<center>
	<button type="button" id="btn-test-connection-controller" class="btn btn-primary btn-lg"><i class='fa fa-cogs'></i> Test Connection</button> <button id="btn-save-controller" type="submit" class="btn btn-success btn-lg"><i class='fa fa-save'></i> Save</button>
   </center>
</form>