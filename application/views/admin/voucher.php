    ...
    if ($voucher)
    	{
    		  	   	   	  ...
    		  	   	   	  $logo =  base_url('public/src/img/') . $voucher['voucher_logo'] . ".png?dummy=" . rand(10,999) ;
                                ...
                                <center> <br>
                                  ...
                                  <form id = "uploadfile" method="Post" enctype="multipart/form-data">
                                       ...
                                       <input name="fileToUpload"  id="fileToUpload" type="file" onchange="loadFile(event)" style="display:none"></input>
											...
											<button type="button" id = "btn-test-print" class="btn btn-primary"><i class='fa fa-print'></i> Print Test</button> <button type="submit" id = "btn-save" class="btn btn-success"><i class='fa fa-save'></i> Save</button>
							        </form>